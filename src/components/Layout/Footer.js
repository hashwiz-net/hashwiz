          ...
          <Container>
            <Row>
              <Col
                ...
                name="footercolumn"
              >
                <h5 className="text-light footer-head">Hashwiz</h5>
                <p className={this.props.isLight ? "mt-4 text-muted" : "mt-4"}>
                  Let us help you put your idea into design and development to build your product on the blockchain. 
                </p>
             ...
             {/*  <Col
              ...
              >
                ...
                <p className="mt-4">
                  Send us your requirement and we will get back to you with a quote.
                </p>
                {/* <Form> */}
                  <Row>
                    {/* <Col lg="12">
